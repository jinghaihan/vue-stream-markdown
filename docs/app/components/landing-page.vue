    ...
    <section class="landing-hero">
      <div class="hero-copy">
        ...
        <div class="hero-actions">
          <NuxtLink class="primary-action" to="/guide">
            Read the docs
...
.landing-page {
  ...
  --landing-ink: var(--ui-text-highlighted);
  --landing-muted: var(--ui-text-muted);
  --landing-line: color-mix(in srgb, var(--ui-border) 82%, transparent);
  --landing-panel: color-mix(in srgb, var(--ui-bg) 88%, var(--landing-accent) 12%);
...
.stream-stage {
  ...
  background:
    linear-gradient(180deg, color-mix(in srgb, var(--landing-panel) 94%, transparent), var(--ui-bg)), var(--ui-bg);
  border: 1px solid var(--landing-line);
