...
description: Configure internationalization settings for vue-stream-markdown with support for multiple languages.
---
...
If you're creating custom Markdown or UI components, you can use the `useI18n` composable to access translations:
