...
::stream-markdown{example="config-display-options.codeExample" code-options-example="config-display-options.languageIconOnly"}
::
...
::stream-markdown{example="config-display-options.codeExample" code-options-example="config-display-options.languageNameOnly"}
::
...
::stream-markdown{example="config-display-options.codeExample" code-options-example="config-display-options.lineNumbersOnly"}
::
...
::stream-markdown{example="config-display-options.imageWithoutCaption" image-caption="false"}
::
...
::stream-markdown{example="config-display-options.imageWithFallback" image-fallback="https://placehold.co/600x400"}
::
