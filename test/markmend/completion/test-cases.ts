...
export const deleteTestCases: TestCasesByCategory = {
  delete: [
    ...
    },
    {
      ...
      input: '~',
      expected: '~',
      completionOptions: preserveBareFormattingMarkers,
    },
    {
      description: 'should hide bare ~~ by default',
      input: '~~',
...
export const mathTestCases: TestCasesByCategory = {
  math: [
    ...
    },
    {
      ...
      completionOptions: { singleDollarTextMath: true },
    },
    {
...
function keepStreamingCase(
  description: string,
  input: string,
  completionOptions?: TestCase['completionOptions'],
): TestCase {
  return {
    description,
    expected: input,
...
export const streamingBlockCompletionCases: TestCase[] = [
  ...
  completeStreamingCase('comparison before currency', '- > $100: expensive', '- \\> $100: expensive'),
  {
    ...
    input: '- > 25: rich',
    expected: '- > 25: rich',
    completionOptions: { comparisonOperators: false },
  },
