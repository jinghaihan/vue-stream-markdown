...
export const streamingDelimiterSafetyCases: TestCase[] = [
  ...
  keepStreamingCase('escaped asterisk before incomplete italic', '\\*escaped and *italic'),
  ...
  completeStreamingCase('single tilde between numbers', '20~25°C', '20\\~25°C'),
  completeStreamingCase('multiple numeric single tildes', '20~25°C。20~25°C', '20\\~25°C。20\\~25°C'),
  completeStreamingCase('single tilde between ASCII letters', 'foo~bar', 'foo\\~bar'),
  completeStreamingCase('multiple intraword single tildes', 'foo~bar~baz', 'foo\\~bar\\~baz'),
  completeStreamingCase('single tilde between Japanese characters', '日本~語', '日本\\~語'),
  completeStreamingCase('single tilde between Greek characters', 'α~β', 'α\\~β'),
